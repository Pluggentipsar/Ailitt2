    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="relative h-64 sm:h-80">
          {/* Ref-linjer */}
          <div className="absolute inset-x-0 top-0 flex flex-col justify-between text-[10px] text-[#64748b]">
            <div className="border-b border-dashed border-[#243248] pb-1">
              <span className="ms-mono">14 TIM</span>
            </div>
          </div>
          <div className="absolute inset-x-0 top-1/3 border-b border-dashed border-[#243248]">
            <span className="ms-mono text-[10px] text-[#64748b]">
              50 MIN
            </span>
          </div>
          <div className="absolute inset-x-0 top-2/3 border-b border-dashed border-[#243248]">
            <span className="ms-mono text-[10px] text-[#64748b]">
              ~3 MIN
            </span>
          </div>
          ...
          <div className="absolute inset-0 flex items-end justify-around gap-2 px-2 pb-8">
            {DATA.map((d, i) => {
              ...
              return (
                ...
                >
                  <div
                    className="ms-mono mb-1 text-[10px] text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    style={{
                      opacity: visible ? 1 : 0,
          ...
          <div className="absolute inset-x-0 bottom-0 flex justify-around gap-2 px-2">
            {DATA.map((d) => (
              <div
                key={d.year}
                className="ms-mono flex-1 text-center text-[10px] text-[#94a3b8] sm:text-xs"
              >
                {d.year}
              </div>
            ))}
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-2">
          <div className="rounded-lg border border-[#243248] bg-[#1a2235] p-4">
            <div className="ms-mono mb-1 text-[#94a3b8]">FÖRDUBBLING</div>
            <div className="text-2xl font-bold text-white">~7 mån</div>
            <div className="text-xs text-[#94a3b8]">
              Tidshorisonten dubblas ungefär var 7:e månad sedan 2019.
            </div>
          </div>
          <div className="rounded-lg border border-[#243248] bg-[#1a2235] p-4">
            <div className="ms-mono mb-1 text-[#94a3b8]">FRÅN → TILL</div>
            <div className="text-2xl font-bold text-white">25 200×</div>
            <div className="text-xs text-[#94a3b8]">
        ...
        <div className="mt-4 rounded-lg border border-[#fcd34d]/40 bg-[#fcd34d]/5 p-4 text-sm leading-relaxed text-[#fde68a]">
          <strong className="text-white">Vad betyder det?</strong> Om trenden
