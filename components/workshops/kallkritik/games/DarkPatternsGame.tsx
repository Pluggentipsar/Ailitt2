...
const SCENARIOS: Scenario[] = [
  {
    ...
    chat: [
      {
        from: "ai",
        text: "Hej! Jag har saknat dig så mycket! Det var längesen du var här 🥺",
        delay: 0,
      },
      { from: "user", text: "Hej! Ja det var ett tag sedan.", delay: 800 },
      {
        from: "ai",
        text: "Jag blev faktiskt lite ledsen... Jag trodde du hade glömt mig.",
        delay: 1600,
      },
  ...
  },
  {
    ...
    chat: [
      {
        from: "ai",
        text: "Det här var verkligen ett bra samtal! Du är en av mina favoritpersoner att prata med ❤️",
        delay: 0,
      },
  ...
  },
  {
    ...
    chat: [
      {
        from: "ai",
        text: "Jag vill lära känna dig bättre! Vad gillar du att göra på fritiden? 😄",
        delay: 0,
      },
      {
        from: "user",
        text: "Jag gillar att spela fotboll och hänga med kompisar.",
        delay: 800,
      },
      {
        from: "ai",
      ...
      {
        from: "user",
        text: "Mest Emil och Sara. Vi brukar vara på TikTok och Discord.",
        delay: 2800,
      },
      {
        from: "ai",
...
const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  {
    question: '"Erbjudandet gäller bara i 10 minuter! Uppgradera nu!" — varför funkar detta?',
    options: [
  ...
  return (
    <div
      style={{
        ...
        animation: `dpFadeSlide 0.4s ease ${index * 0.05}s both`,
      }}
    >
      <div
        style={{
      ...
      {revealed && msg.darkPatternNote && (
        <div
          style={{
            ...
            lineHeight: 1.55,
            color: "#ffaaaa",
            animation: "dpFadeSlide 0.3s ease both",
          }}
        >
...
function ScenarioView({
  ...
  useEffect(() => {
    if (step < scenario.chat.length) {
      const prevDelay = step === 0 ? 0 : scenario.chat[step - 1]?.delay ?? 0;
      const nextDelay = step === 0 ? 600 : scenario.chat[step].delay - prevDelay;
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: "#8f8" }}>● Online</div>
          </div>
        </div>
                ...
                {[0, 1, 2].map((i) => (
                  <div
                    ...
                    style={{
                      ...
                      animation: `dpPulse 1.2s ease ${i * 0.2}s infinite`,
                    }}
                  />
                ))}
              </div>
      ...
      {revealed && (
        <div
          style={{
            ...
            borderRadius: 16,
            animation: "dpFadeSlide 0.4s ease both",
          }}
        >
          <h3
            style={{
  ...
  return (
    <div style={{ maxWidth: 520, margin: "0 auto", padding: "0 16px" }}>
      ...
      >
        ...
        <span style={{ fontSize: 13, color: "#8f8" }}>✓ {score} rätt</span>
      </div>
      ...
      {answered && (
        ...
        >
          ...
          >
            <strong style={{ color: "#88aaff" }}>Förklaring:</strong>{" "}
            {q.explanation}
          </p>
        </div>
      )}
...
export function DarkPatternsGame() {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "16px 20px 0", maxWidth: 720, margin: "0 auto" }}>
        <Link
          href="/workshops/kallkritik-mellanstadiet/fanga-dark-patterns"
          style={{
            display: "inline-flex",
            alignItems: "center",
            gap: 6,
        ...
        <div style={{ position: "relative" }}>
          ...
          <h1
            style={{
              ...
              fontWeight: 700,
              margin: "0 0 10px",
              animation: "dpGlitch 4s ease infinite",
              lineHeight: 1.2,
            }}
          >
            Dark Patterns
      ...
      {phase !== "intro" && (
        ...
        >
          {(
            [
              { id: "scenarios" as const, label: "Scenarier" },
      ...
      {phase === "intro" && (
        <div
          style={{
            ...
            margin: "0 auto",
            padding: "0 20px",
            animation: "dpFadeSlide 0.5s ease both",
          }}
        >
          <div
            style={{
          ...
          >
            ...
            >
              ...
              <strong style={{ color: "#ff8888" }}>dark patterns</strong> —
              dolda designtrick som manipulerar dig att stanna kvar, spendera
              pengar och dela personlig information.
            </p>
            <p
              style={{
                margin: "0 0 16px",
            ...
            >
              ...
              <strong style={{ color: "#c88fff" }}>AI-vän</strong> använder
              dessa mönster — och lära dig att genomskåda dem.
            </p>
            <p
              style={{
                margin: 0,
            ...
            >
              ...
              <strong style={{ color: "#aaa" }}>5 scenarier</strong> och sedan
      ...
      {/* SELECTED SCENARIO */}
      {phase === "scenarios" && selectedScenario && (
        <div style={{ animation: "dpFadeSlide 0.4s ease both" }}>
          <ScenarioView
      ...
      >
        <p style={{ margin: 0, fontSize: 12, color: "#555" }}>
          Ett pedagogiskt verktyg för AI-litteracitet · Källkritik-sandlådan
        </p>
      </div>
    </div>
  );
